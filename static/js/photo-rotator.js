...
(function () {
  ...
  function injectSignatureStyles() {
    ...
    el.textContent = [
      ...
      ".voa-sig-block .voa-sig-cta{font-family:'Space Grotesk','Lora',sans-serif;font-size:0.92rem;line-height:1.7;color:rgba(245,234,216,0.72);max-width:800px;margin:0.3rem auto 0;letter-spacing:0.01em;}",
      ...
      ".voa-photo-rotator[data-theme='boom'] .voa-sig-name{color:rgba(0,229,255,0.9);font-family:'Rajdhani','Space Grotesk',sans-serif;font-size:0.75rem;font-weight:700;letter-spacing:0.22em;font-variant:normal;text-transform:uppercase;}",
  ...
  function initSignature(container, metadata) {
    ...
    var LANDSCAPE_FILES = ["treeyoga.jpeg", "treeyoga.jpg", "fulllotus.jpeg", "fulllotus.jpg", "treefort2.jpeg"];
